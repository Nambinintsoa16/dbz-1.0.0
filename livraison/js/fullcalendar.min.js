...
(function(m, ma) {
    ...
    var Ya = {
            ...
            monthNamesShort: ["Jan",
                "Fév", "Mar", "Avr", "Mai", "Jui", "Jul", "Aoû", "Sep", "Oct", "Nov", "Dec"
            ],
            dayNames: ["Dimanche", "Luindi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"],
    ...
    Aa.formatDate = Oa;
    Aa.formatDates = ib;
    var lc = ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"],
        Ab = 864E5,
        cc = 36E5,
        wc = 6E4,
        dc = {
            ...
            t: function(a) { return a.getHours() < 24 ? "h" : "h" },
            tt: function(a) { return a.getHours() < 24 ? "h" : "h" },
            T: function(a) {
                return a.getHours() <
                    12 ? "A" : "P"
            },
